...
router bgp 65500
   ...
   bgp listen range 10.0.2.0/28 peer-group UNDERLAY remote-as 65500
...
router bgp 65500
   ...
   neighbor 10.0.2.0 description Spine1
...
router bgp 65500
   ...
   neighbor 10.0.2.2 description Spine1
...
router bgp 65500
   ...
   neighbor 10.0.2.4 description Spine1
